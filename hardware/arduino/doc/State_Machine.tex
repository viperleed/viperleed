...
\item \texttt{STATE\_CHANGE\_MEASUREMENT\_MODE}: Sets the boolean \texttt{singleMeasurement} either to true or false. True will result in a single measurement cycle beeing done when requested by the user. False will make the arduino repeat measuring and returning data. It also sets \texttt{measurementsToDo} to 1.
