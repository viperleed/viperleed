...
#define INA239_SPI_MODE   SPI_MODE1      // SPI_MODE1 means CPOL=0, CPHA=1
#define INA239_SPI_SETTINGS SPISettings(INA239_SPI_BAUD, MSBFIRST, INA239_SPI_MODE)

// INA239 constants
#define INA239_I_MAX        4           // Maximum expected current in Amperes
// For a maximum resolution of the current measurement choose a shuntresistor,
// at which the maximum expected potential difference
// (U_SHUNT_MAX = R_SHUNT * I_MAX) is either near to 163.84 mV (ADC_RANGE = 0)
// or 40.96 mV (ADC_RANGE = 1), i.e. for U_SHUNT_MAX = 0.01 * 4 = 40 mV choose
// ADC_RANGE = 1, see 'INA239_ADC_RANGE'
#define INA239_R_SHUNT      0.01        // Shunt resistance in Ohm
...
DEVICE_ID           0x3F  // NOT USED; Device identification and revision       // TODO: Implement for identification of the whole device (INA + MD + COIL)?
*/
...
class INA239 {
  public:
    ...
    // Voltage at PIN8, in V. Typically, the supply voltage of the motordriver.
