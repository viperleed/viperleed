...
def fe2o3_012_exp_spline_and_hk():
    exp_out_beams = readOUTBEAMS('/Users/alexander/GitHub/on-the-fly-deltas/tests/test_data/Fe2O3_012/converged/EXPBEAMS.csv')
...
def fe2o3_012_theo_spline_exp_spline_and_R(v0r_shift, expected_R,
                                           fe2o3_012_exp_spline_and_hk):
    exp_spline, exp_hk = fe2o3_012_exp_spline_and_hk
    theo_out_beams = readOUTBEAMS('/Users/alexander/GitHub/on-the-fly-deltas/tests/test_data/Fe2O3_012/converged/OUT/THEOBEAMS.csv')
    ...
    theo_spline = interpolate_ragged_array(theo_energies + v0r_shift,
                                           theo_beams)
...
class SplinesWithExpectedValues:
    ...
    def case_sin_correlated(self, sin_spline):
        ...
        v0i, energy_step, energies = 3., 0.5, _MOCK_FINE_E_AXIS
        expected_R = 0.0
    ...
    def case_fe2o3_012_refcalc(self, fe2o3_012_theo_spline_exp_spline_and_R):
        exp_spline, theo_spline, energies, expected_R = fe2o3_012_theo_spline_exp_spline_and_R
        v0i, energy_step = 5., 0.5
        return theo_spline, v0i, energy_step, energies, exp_spline, expected_R

@parametrize_with_cases(
    "theo_spline, v0i, energy_step, energies, exp_spline, expected_R",
    cases=SplinesWithExpectedValues, has_tag="pendry")
def test_pendry_R_from_splines(theo_spline, v0i, energy_step,
                               energies, exp_spline, expected_R):
    """Test the R-factor calculation from spline objects."""
    calc_R = rfactor.pendry_R(theo_spline, v0i, energy_step,
                              energies, exp_spline)
