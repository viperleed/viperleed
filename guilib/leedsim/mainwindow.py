...
class LEED_GUI(qtw.QMainWindow):
    ...
    def exportBeamsPressed(self):
        ...
        if not hasattr(self, 'exportDialog'):
            self.exportDialog = gl.ExportCSVDialog(self.leed, parent=self)
    ...
    def exportCSV(self, lines):
        ...
        # Now prepare a few lines of commented header
        header = ['# This file was automatically generated by ViPErLEED v.' 
                  + self.version + '.']
        if hasattr(self, 'openFile') and self.openFile:
            header.append('# It contains the list of LEED beams generated from'
                          ' input file:\n# ' + self.openFile)
        header.append('#')
        lines = [*header, *lines]
