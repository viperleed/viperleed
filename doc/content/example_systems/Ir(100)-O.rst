...
and a relatively rough grid, as in :numref:`list_ir_displacements_rough`.
...
the :ref:`error of the tensor-LEED approximation<tensor_leed_errors>` used for the structure
optimization. In this case, the real |R factor| — as obtained from the
...
Now, remember that in the :ref:`PARAMETERS file<parameters>` of
