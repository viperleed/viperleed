...
-  We would like to compare these intensities with a Ag(100)-(1×1) surface
   ...
   :ref:`POSCAR file<poscar>` (see :numref:`list_ag_poscar`).
...
We then create a :ref:`PARAMETERS file<parameters>`
(cf. :numref:`list_ag_paramters`) which tells
ViPErLEED what to do.
...
PARAMETERS FOR VIBROCC
   ...
   parameters. By further setting :ref:`VIBR_AMP_SCALE<VIBR_AMP_SCALE>`,
...
.. _fig_ag_phaseshifts:
.. figure:: /_static/example_systems/Ag(100)/Phaseshifts_plots.pdf
   :width: 450px
   :align: center
...
.. _fig_ag_iv_plot:
.. figure:: /_static/example_systems/Ag(100)/Rfactor_plots_refcalc.pdf
   :width: 450px
   :align: center
...
:ref:`DISPLACEMENTS file<displacements>` (see
:numref:`list_ag_displacements_rough`).
...
.. figure:: /_static/example_systems/Ag(100)/Search-progress.pdf
   :width: 450px
   :align: center
