...
|IV| curves and a file :ref:`Rfactor_plots_refcalc.pdf<rfactorplots>`, in which
the experimental and theoretical beams are plotted.
...
The |IV| curves clearly show a good qualitative agreement, but the R factor of
:math:`R \approx 0.17` is not great for such a simple system! We therefore
proceed to the :ref:`delta-amplitudes<sec_deltas>` calculation and the
