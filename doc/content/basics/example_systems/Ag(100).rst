...
You can find the input files for all stages here.
...
To do this in ViPErLEED, we run a :ref:`delta-amplitude<sec-deltas>` calculation followed by a :ref:`structure search<sec-search>`.
