...
.. container:: center
   ...
   +-----------------------+------------+--------------------+-------------------+--------------+
   | Original message      | Data bytes | Meaning of data    | Reply             | Reply bytes  |
   |                       |            | bytes              |                   |              |
   +=======================+============+====================+===================+==============+
   |``PC_CONFIGURATION``   | —          | —                  |version + hardware |4             |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |``PC_CALIBRATION``     | 3          |adcRate, adc0Ch.,   |(done) ``PC_OK``   |1             |
   |                       |            |adc1Ch.             |                   |              |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |``PC_SET_UP_ADCS``     | 4          |no. meas. MSB, no.  |(data OK) ``PC_OK``|1             |
   |                       |            |meas. LSB, adc0Ch., |                   |              |
   |                       |            |adc1Ch.             |                   |              |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |``PC_AUTOGAIN``        | —          | —                  |(done) ``PC_OK``   |1             |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |``PC_SET_VOLTAGE``     | 4          |dacValue MBS,       |(done waiting)     |1             |
   |                       |            |dacValue LSB        |``PC_OK``          |              |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |                       |            |dacSettlingTime MSB,|(meas. ready) 3    |3             |
   |                       |            |dacSettlingTime LSB |:math:`\times`     |:math:`\times`|
   |                       |            |                    |data               |4             |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |``PC_MEASURE_ONLY``    | —          | —                  |(starting)         |1             |
   |                       |            |                    |``PC_OK``          |              |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |                       |            |                    |(meas. ready) 3    |3             |
   |                       |            |                    |:math:`\times`     |:math:`\times`|
   |                       |            |                    |data               |4             |
   +-----------------------+------------+--------------------+-------------------+--------------+
   |``PC_CHANGE_MEAS_MODE``| 1          |set meas. mode      |(done) ``PC_OK``   | 1            |
   +-----------------------+------------+--------------------+-------------------+--------------+
...
.. container:: center
   ...
   +---------------------------------+-----------------------+-------------------------------+--------------------------+
   |``STATE_CHANGE_MEASUREMENT_MODE``|``PC_CHANGE_MEAS_MODE``|``changeMeasurementMode()``    |``STATE_IDLE``            |
   +---------------------------------+-----------------------+-------------------------------+--------------------------+
