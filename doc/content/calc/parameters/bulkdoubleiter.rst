...
the bulk. See :ref:`BULKDOUBLEEPS`  for more information on layer doubling.
...
.. note::
    ...
    wrong (e.g., geometry input/:ref:`POSCAR` file). Large values for
    ...
    criterion on :ref:`BULKDOUBLEEPS`  should be satisfied much earlier
