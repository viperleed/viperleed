...
+----------------------------------------------------------------------+------------------------------------------------------------------------+---------------------------------------------------+
| :ref:`Rfactor_plots.pdf<rfactorplots>`                               | Plots of experimental and theoretical |IV| curves with |R factor|\ s   | |R-factor| calculation                            |
+----------------------------------------------------------------------+------------------------------------------------------------------------+---------------------------------------------------+
| :ref:`Rfactor_analysis.pdf<rfactoranalysis>`                         | Same as Rfactor_plots, with Y-functions and analysis                   | |R-factor| calculation                            |
+----------------------------------------------------------------------+------------------------------------------------------------------------+---------------------------------------------------+
| :ref:`Errors.csv, Errors.pdf<Errorspdf>`                             | |R factor|\ s for one-dimensional parameter variation                  | :ref:`Error calculation<error_calculation>`       |
+----------------------------------------------------------------------+------------------------------------------------------------------------+---------------------------------------------------+
| :ref:`FD_Optimization.csv, FD_Optimization.pdf<fdoptimizationdata>`  | |R factor|\ s for variation in full-dynamic optimization               | :ref:`Full-dynamic optimization<Fdoptimization>`  |
+----------------------------------------------------------------------+------------------------------------------------------------------------+---------------------------------------------------+
