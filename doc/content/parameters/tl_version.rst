...
(see the :ref:`How to Run section<how_to_run>`).
If ``TL_VERSION`` is not set, ViPErLEED will use the latest version found in the
specified directory.

**Default:** None, picks the latest version number found in the ``tensorleed`` 
directory.
