...
defined by the tolerance :ref:`SYMMETRY_EPS<sym_eps>`.
...
wants to use symmetry detection with a large :ref:`SYMMETRY_EPS<sym_eps>`  in
order to automatically move almost-symmetry-equivalent atoms in concert.
...
:ref:`SYMMETRY_FIX<ISYM>`. If the symmetry is reduced or deactivated by
:ref:`SYMMETRY_FIX<ISYM>`, symmetrization of atom positions will only be
