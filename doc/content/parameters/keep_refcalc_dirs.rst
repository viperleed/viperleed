...
KEEP_REFCALC_DIRS is a boolean paramterer that toggles whether the sub-directories in which the :ref:`reference calculation<ref-calc>` for each energy step is executed are kept after the section finishes.
