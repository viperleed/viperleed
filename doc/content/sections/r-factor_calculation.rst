...
-  :math:`R_P` compares the logarithmic derivatives of the |IV| data, a fix
...
R factors for more open surfaces, such as missing-row-reconstructed Pt(110),
can be higher than 0.2.
...
the intensities approach zero, :math:`R_P` is especially sensitive to small
differences; artificially increasing the intensity there leads to lower values
of :math:`R_P`.
...
the |IV|-curve editor in the :ref:`ViPErLEED Spot Tracker<spot_tracker>`.
