...
It contains the R factors between the input |IV| data
...
parameters to find a best fit structure. In TensErLEED this is generally
performed by brute force over a grid, i.e. by calculating the  R factors
for each step on the requested :math:`V_{0r}` grid. See the parameter
