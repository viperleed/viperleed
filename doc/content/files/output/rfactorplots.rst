...
``Rfactor_plots_refcalc.pdf`` is generated after the :ref:`R-factor calculation<r-factor>` following the :ref:`refercence calculation<ref-calc>` (section :ref:`RUN = 11<run>`), while ``Rfactor_plots_superpos.pdf`` is generated after the :ref:`R-factor calculation<r-factor>` following the :ref:`superposition<superpos>` (section :ref:`RUN = 12<run>`).
