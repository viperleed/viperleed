...
3,Department of Physics, Chemistry and Biology, Linköping University, 58183 Linköping, Sweden
 ...
 do while(iarg <= argc)
   ...
   selectcase(adjustl(argv))
     case("--help", "-h")
rite(*,*)"Object files are ~/bin/eeasisss and ~/bin/eeas, "
rite(*,*)"working directory is ./ ."
rite(*,*)"===================================================================="
rite(*,*)"--help or -h shows working space organization:"
rite(*,*)"FILES"
rite(*,*)"--input, -i <name of input file>, default is inputX ."
rite(*,*)"--log, -l <name of log file>, default is logX ."
rite(*,*)"DIRECTORIES"
rite(*,*)"--output_dir, -o <path to log file and phase shifts>, "
rite(*,*)"  default is ./result/ ."
rite(*,*)"--atom_dir, -a <path to charge density files>, default is ~/atlib/ ."
rite(*,*)"--------------------------------------------------------------------"
rite(*,*)"Please contact John Rundgren <jru@KTH.se> for queries and comments."
       stop
     case("--input", "-i")
