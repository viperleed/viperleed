...
C  PPP   : Clebsh-Gordon coefficients for computation of temperature-
...
C  VV: real part of the inner potential
...
C  NLMBS is dimension of BELM as function of LMAX
     ...
     *     NLMBS(13),NLMBS(14),NLMBS(15),NLMBS(16),NLMBS(17),NLMBS(18)
     *     /19,126,498,1463,3549,7534,14484,25821,43351,69322,106470,
     *      158067,227969,320664,441320,595833,790876,1033942/
...
C  write results to output file DELWV
        ...
        CALL OUTRINT(10,FORMOUT,E,VV,VPIS,NT0,NTOT,XIST,DELWV_DWG)
