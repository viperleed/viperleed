...
gfortran -c -g -Og ../rfactor/rfactor.f90 -fbacktrace -fcheck=all -Wuninitialized -static
cp ../rfactor/rfactor.mod ./rfactor.mod
cp ../rfactor/rfactor.o ./rfactor.o

# Subroutines must be given in lowercase characters here
...
f2py -c --f90flags="-g -Og -fbacktrace -fcheck=all -fPIC" rfactor.pyf ../rfactor/rfactor.f90 -I ../interpolation/interpolation.f90 -llapack

cp interpolation.cpython**.so ../../../tleedmlib/wrapped
cp rfactor.cpython**.so ../../../tleedmlib/wrapped
