...
e_start_beams_out, n_e_beams_out, intpol_intensity, intpol_derivative, y_func = rf.prepare_beams(E_grid_in, intensities,
	E_start_beams, n_E_beams, skip_stages, n_beams_out,
    averaging_scheme,
	deg, E_grid_out)
