...
C  for use with TensErLEED ref-calc.f v1.2 .
C  VB, 14.04.00
C
...
C  R.Doell
C  - Version that can be used also for larger superlattices (DIM KNBS(20))
...
C
      INTEGER SSYM,LATMAT(2,2),KSYM(2,9999),NBSET(9999),KNB(20)          210492
      DIMENSION ARA1(2),ARA2(2),SPQF(2,9999),G(2,9999),GS1(2),GS2(2)
...
C---------------------------------------------------------------------------
     ...
     1SPQF,G,KNT,KSYM,NBSET,KNBS,KNB,RAR1,RAR2)
      INTEGER SSYM,LATMAT(2,2),KSYM(2,9999),NBSET(9999),KNB(20)         210492
      INTEGER SSYMA(2,9999),LSYMSA(2,9999)                              210492
      DIMENSION ARA1(2),ARA2(2),RAR1(2),RAR2(2),RBR1(2),RBR2(2)
      DIMENSION GDUMMY(2,9999)                                          210492
      DIMENSION ALMR(2,2),SPQF(2,9999),G(2,9999),ST(4),GU(2,12),GS(2,12)
     1,DG(2)
