...
C  v1.5 (search version v107), WM 18.04.09
C  for use with lib.search.f v1.5, random_.c
C
C  as described in 
C
...
C  Broadcast input data to other processes
     ...
     *                    MPI_COMM_WORLD,IERR)
      ...
      CALL MPI_BCAST(VO,MNDATT,MPI_REAL,0,MPI_COMM_WORLD,IERR)
