...
68    WRITE(6,70)IBE,(BENAME(I,IBE),I=1,5),IBT,(PQAV(I,IBT),I=1,2)
70    FORMAT(9H0BEAM NO.,1I3,10H IN EXP. (,5A4,20H), WHICH IS BEAM NO.,
     11I3,12H IN THEORY (,2F12.4,1H))
...
C Values for averaging of beams in integer and half order beams
      READ(5,*) 
      READ(5,'(25I3)') (MITTEL(I),I=1,NBED)

C beam order IBP, beam weights WR

      READ(5,*)
      READ(5,'(25I3)')   (IBP(I),I=1,NBED)
      READ(5,'(25F3.1)') (WB(I),I=1,NBED)
...
C  Read in headers of all files
     ...
     +                              (TRAR2(I),I=1,2)
            READ(CNTFIL,'(2I3,I4)') INT0,NATOMS,NCSTEP
