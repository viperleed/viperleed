...
def rfactor(sl, rp, index, for_error=False, only_vary=None):
    ...
    return run_legacy_rfactor(sl, rp, for_error, name, theobeams, expbeams, index, only_vary)
...
def run_new_rfactor(sl, rp, for_error, name, theobeams, expbeams):
    ...
    v0i = rp.V0_IMAG
        ...
        # Should we do reordering averaging etc. using the subroutine? - unused right now...
...
def run_legacy_rfactor(sl, rp, for_error, name, theobeams, expbeams, index, only_vary):
