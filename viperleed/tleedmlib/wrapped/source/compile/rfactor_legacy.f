...
C  include problem dependent parameter statements for dimensions
      ...
      integer :: n_beams
      integer :: n_E_out
      integer :: n_E_exp, n_E_theo
      real(8), ALLOCATABLE :: energies_out(:)
      
      
      integer, ALLOCATABLE:: n_E_beams_exp(:), E_start_beams_exp(:)
      integer, ALLOCATABLE:: n_E_beams_theo(:), E_start_beams_theo(:)
      real(8), ALLOCATABLE :: exp_grid(:), theo_grid(:)
      real(8), allocatABLE :: intensities_exp(:,:)
      real(8), ALLOCATABLE :: intensities_theo(:,:)


      integer, ALLOCATABLE :: E_start_beams_out_exp(:)
      integer, ALLOCATABLE :: n_E_beams_out_exp(:)
      integer, ALLOCATABLE :: E_start_beams_out_theo(:)
      integer, ALLOCATABLE :: n_E_beams_out_theo(:)

      integer, ALLOCATABLE :: averaging_scheme_exp(:)
      integer, ALLOCATABLE :: averaging_scheme_theo(:)
      integer :: deg
<<<<<<< Updated upstream
=======
<<<<<<< Updated upstream
...
>>>>>>> Stashed changes
>>>>>>> Stashed changes
      integer :: skip_stages(5)
      integer :: ierr
      real(8) :: V0i

      real(8), ALLOCATABLE :: E_grid_out(:)
      real(8), ALLOCATABLE :: intpol_intensity(:,:) ! used by both exp and theo - make second array if needed
      real(8), ALLOCATABLE :: intpol_derivative(:,:) ! used by both exp and theo - make second array if needed
...
<<<<<<< Updated upstream
=======
      real(8), ALLOCATABLE :: numerators_beams(:)
      real(8), ALLOCATABLE :: denominators_beams(:)
>>>>>>> Stashed changes
>>>>>>> Stashed changes
...
=======
      integer :: n_groups
      real(8), ALLOCATABLE :: rfactor_integer_fractional(:)
      integer, ALLOCATABLE :: n_overlapp_integer_fractional(:)
>>>>>>> Stashed changes
>>>>>>> Stashed changes
      integer :: beam
...
!*****************************************************************************   
      ...
      ALLOCATE(n_E_beams_exp(n_beams), E_start_beams_exp(n_beams))
      
      
      CALL translate_exp(n_beams, MNGP, NEE, EE, AE,
     *  n_E_exp, exp_grid, E_start_beams_exp, n_E_beams_exp, 
     *  intensities_exp)
...
C  read in calculated energies and intensities (in range EMIN to EMAX)
     ...
     *          EMIN,EMAX,LIMFIL,NSSK,NS,MNBTD)                          281279
      REWIND(5) ! So it's rewound for future use by legacy code

      print*, "read of theodata sucess"

      if (MNS > 1) print*, "Muliple geometries not supported"

      ALLOCATE(averaging_scheme_theo(n_beams))

      averaging_scheme_theo = KAV

      ALLOCATE(n_E_beams_theo(n_beams), E_start_beams_theo(n_beams))

      ALLOCATE(E_start_beams_out_theo(n_beams))
      ALLOCATE(n_E_beams_out_theo(n_beams))



      CALL translate_theo(n_beams, MNGP, MNBTD, ES, ATS,
     * n_E_theo, theo_grid, E_start_beams_theo, n_E_beams_theo,
     * intensities_theo)
...
>>>>>>> Stashed changes
      ...
      CALL prepare_beams(n_beams, n_E_exp, exp_grid, intensities_exp, 
     * E_start_beams_exp, n_E_beams_exp, skip_stages, n_beams, 
     * averaging_scheme_exp, 
<<<<<<< Updated upstream
=======
<<<<<<< Updated upstream
=======
...
>>>>>>> Stashed changes
     ...
     * V0i,
     * E_start_beams_out_exp,
     * n_E_beams_out_exp,
<<<<<<< Updated upstream
     * intpol_intensity, intpol_derivative, y_exp, ierr)
=======
<<<<<<< Updated upstream
     * intpol_intensity, intpol_derivative, y_exp, ierr)
=======
     * intpol_intensity, y_exp, ierr)
>>>>>>> Stashed changes
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
=======
      ALLOCATE(denominators_beams(n_beams))
      ALLOCATE(numerators_beams(n_beams))
>>>>>>> Stashed changes
>>>>>>> Stashed changes
...
=======
      ...
      print*, "exp estartt", E_start_beams_out_exp
      print*, "theo estart", E_start_beams_out_theo
      print*, "exp n", n_E_beams_out_exp
      print*, "theo n", n_E_beams_out_theo
      print*, "theo n in", n_E_beams_theo


      CALL r_beamset_V0r_opt_on_grid( which_R,
>>>>>>> Stashed changes
>>>>>>> Stashed changes
...
=======
     ...
     *  tol_R, tol_R_2, max_fit_range)
      ...
      print*, "pre grouping", r_pendry_beams


      ! get R factors and overlapp for subgroups of integer and fractional beams
      ! beams are assigned to groups in variable MITTEL

      n_groups = 2 ! Two groups: integer and fractional
      ALLOCATE(n_overlapp_integer_fractional(n_groups))
      ALLOCATE(rfactor_integer_fractional(n_groups))

      call r_beamtype_grouping(which_r, n_beams, 
     *  r_pendry_beams, numerators_beams, 
     *  denominators_beams,
     *  n_overlapping_points, n_groups, MITTEL, 
     *  rfactor_integer_fractional,
     *  n_overlapp_integer_fractional, ierr)
...
=======
      ...
      IF (NINT.NE.0) THEN
        WRITE(7,9125) -1,D12,best_V0r,EMIN,EMAX,
     *    (n_overlapp_integer_fractional(1) - NINT)*E_step,
     *    rfactor_integer_fractional(1)
      ENDIF

      IF (NFRAC.NE.0) THEN
        WRITE(7,9126) -1,D12,best_V0r,EMIN,
     *    (n_overlapp_integer_fractional(2) - NFRAC)*E_step,
     *    rfactor_integer_fractional(2)
      ENDIF
>>>>>>> Stashed changes
>>>>>>> Stashed changes
