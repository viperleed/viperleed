"""Module properties of viperleed.gui.measure.camera.drivers.imagingsource.

Collects utilities to access the VCD properties of a Imaging Source
camera.
"""
