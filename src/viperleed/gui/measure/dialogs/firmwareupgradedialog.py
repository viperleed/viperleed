"""Module firmwareupgradedialog of viperleed.gui.measure.dialogs.
...
from viperleed.gui.measure.classes.ioarduinocli import ArduinoCLIInstaller
from viperleed.gui.measure.classes.ioarduinocli import FirmwareArchiveUploader
from viperleed.gui.measure.classes.ioarduinocli import FirmwareUploader
from viperleed.gui.measure.classes.ioarduinocli import FirmwareVersionInfo
from viperleed.gui.measure.classes.ioarduinocli import NOT_SET
...
class FirmwareUpgradeDialog(qtw.QDialog):
    ...
    def _on_install_requests(self):
        ...
        notify.addButton(qtw.QPushButton('Ok'), notify.RejectRole)
        notify.exec_()
