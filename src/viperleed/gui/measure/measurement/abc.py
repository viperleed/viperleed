...
class MeasurementABC(QObjectWithSettingsABC):                                   # TODO: doc about inner workings
    ...
    def get_settings_handler(self):
        ...
        def _resolve_step_profile_limits():
            try:
                ...
                controller_settings = ()
            return _settings.get_step_profile_limits(controller_settings)

        max_steps, max_delay = _resolve_step_profile_limits()
        widget = _settings.StepProfileViewer(
            max_num_steps=max_steps,
            max_delay=max_delay,
            limits_resolver=_resolve_step_profile_limits,
            )
