"""Module leedpattern of viperleed.guilib.leedsim.classes.
...
Defines the LEEDPattern and LEEDsubpattern classes, used for displaying
a LEEDPattern. This is the NEW version of the classes, and replaces the
