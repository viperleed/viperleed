...
#                    bulksites.append(newsite)
    ...
    for (site, el) in blocks:
        ...
        chem_el_paths[el] = charge_density_short_path.resolve().relative_to(rp.paths.work)
        chemels[el] = chemel
...
#    outfilename = 'eeasisss-input-bulk' if bulk else 'eeasisss-input-slab'
    eeasisss_input_path = rp.paths.work / 'eeasisss-input'
    try:
    ...
    phaseshifts_log_name = f'phaseshifts-{rp.timestamp}.log'
    phaseshifts_log_path = rp.paths.work / phaseshifts_log_name
    ...
    filelist = [filename for filename in os.listdir(rp.paths.work) if
    ...
    processed_files = [PSFile(at, rp.paths.work/filename, ps_energy_step)
