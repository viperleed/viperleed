...
def r_pendry(
    ...
    **kwargs
    ...
    if data_and_derivatives_1 is None:
        ...
        data_1_derivative = data_1_deriv_spline(energy_grid)
    else:
        data_1_intensity, data_1_derivative, _ = data_and_derivatives_1
    ...
    if data_and_derivatives_2 is None:
        ...
        data_2_derivative = data_2_deriv_spline(shifted_grid)
    else:
        data_2_intensity, data_2_derivative, _ = data_and_derivatives_2
