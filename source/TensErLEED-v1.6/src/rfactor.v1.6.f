...
C  read beam labelling
 ...
 9    FORMAT(8HMITTEL(,I3,26H) MUST BE EITHER 0, 1 OR 2,/,
     *       36H   *****   PLEASE CORRECT   *****   )
...
C  skip beam if no overlap between experiment and theory occurs
      ...
      IF (EET(IBE).EQ.0.) THEN
        WRITE(6,75) IBE
        WRITE(7,80) (BENAME(I,IBE),I=1,4),IBE,D12,V0R,EMIN,EMAX,0.,0.
...
C  write R-factor averages for current beam to output
      ...
      WRITE(7,80) (BENAME(I,IBE),I=1,4),IBE,D12,V0R,EMIN,EMAX,
     *               EET(IBE),RAVB(IBE)
